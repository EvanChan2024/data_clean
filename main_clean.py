...
def job(topic, topic_new, mqtt_client_id):
    # MQTT 消息到来时的回调函数
...
if __name__ == "__main__":
    ...
    # mqtt_client_id = "test_G204320707L0160_DIS"  # 指定您的 MQTT 客户端标识符
    ...
    for i in range(len(sensor)):
        ...
        # 创建线程
        thread = threading.Thread(target=job, args=(topic, topic_new, mqtt_client_id))
