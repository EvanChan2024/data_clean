...
# 指定日志文件的路径
log_directory = r'E:\sqlite\v3_series\v3.5\log_nd03'
...
if __name__ == "__main__":
    ...
    filtered_data = df[df['SENSOR_SUB_TYPE_NAME'].isin(['竖向位移', '主梁竖向位移', '主梁竖向位移监测', '主梁位移']) & df['SENSOR_POSITION'].isin(['常州', '淮安', '南通', '苏州'])
